        ...
        <>
            <div className='refund-policy-section'>
                ...
                <div className="refund-policy">
                    ...
                    <p className="subHeading">At Gravy Traders, we want our customers to be completely satisfied with their purchases.  </p>
                    <p className="paragraph">
                        ...
                        <br/><br/>
                        3. To initiate a refund, please contact our customer service team at <a href="mailto: support@Gravytraders.com">support@Gravytraders.com</a>.  
                        <br/><br/>
